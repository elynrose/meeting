                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sessions.update", [$session->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="audio_url" id="audio_url">{{ old('audio_url', $session->audio_url) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="transcription" id="transcription">{!! old('transcription', $session->transcription) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="summary" id="summary">{!! old('summary', $session->summary) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="task_created" id="task_created" value="{{ old('task_created', $session->task_created) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_tasks" id="total_tasks" value="{{ old('total_tasks', $session->total_tasks) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tokens_used" id="tokens_used" value="{{ old('tokens_used', $session->tokens_used) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $session->status) }}" required>
